...
public class Messages {
    ...
    static func displaySignInMessage(completionHandler: @escaping (() -> Void), navigateSignUpAction:  @escaping (() -> Void), navigateForgotPassAction:  @escaping (() -> Void), navigateGGsignInAction:  @escaping (() -> Void), fbSignInAction: @escaping(() -> Void)){
        ...
        view.fbSignInAction = fbSignInAction
        view.configureDropShadow()
